...
function getProductCart(product){
    return `<div class="items-div-img"><img class="item-img" src="${this.pic}"></div>
                    <h2 class="items-h2">${this.name}</h2>
                    <p class="item-desc">${this.descr}</p>
                    <p>${this.price}</p>
...
function printProducts(_products) {
    ...
    //проходимося по всім товарамта додаємо верстку зі значенями кожного
